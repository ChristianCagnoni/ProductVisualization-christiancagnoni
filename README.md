...
Per quanto riguarda la libreria `postprocessing.min.js` è stata ricavata da https://github.com/vanruesc/postprocessing . irradiance map ottenute tramite https://github.com/dariomanesku/cmftStudio .